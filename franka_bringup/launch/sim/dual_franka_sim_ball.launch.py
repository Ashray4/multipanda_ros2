...
from launch.actions import DeclareLaunchArgument, IncludeLaunchDescription, Shutdown,ExecuteProcess
...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        ExecuteProcess(
            cmd=['python3', '/home/sysgen/checkout/franka_simul_ws/misc_ws/mujoco_python_tests/ball_action_client.py'],
            name='mouse_throw',
            output='screen',
            shell=False
        ),
